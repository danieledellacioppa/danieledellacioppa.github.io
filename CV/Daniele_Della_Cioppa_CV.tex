...
\resumeItem{Android MDM \& Device Control}
    \resumeItemListStart
        ...
        \resumeSubItem{Designed Remote MDM Server with commands like set\_volume, screenrecord, reboot}
    \resumeItemListEnd
...
\resumeItem{AirPlay Screencasting Project}
    ...
    \resumeItemListEnd
\resumeItem{Additional Context}
\resumeItemListStart
  \resumeSubItem{Currently working as the sole developer on enterprise Android software for military and corporate clients, including MoD and NHS.}
  \resumeSubItem{Competing with companies like CleverTouch and ProWise without equivalent infrastructure, budget, or resources.}
  \resumeSubItem{Engineered a distributed digital signage solution where each Android flat panel can act independently of a central server.}
  \resumeSubItem{Implemented a master-election system among flat panels to enable remote content upload even without AWS or a data center.}
  \resumeSubItem{Designed and deployed a full OTA update mechanism, kiosk lockdown system, Device Policy Management, and a robust MDM server with RSA-authenticated command control.}
\resumeItemListEnd
